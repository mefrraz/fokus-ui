...
const footerLinks = {
  company: [
    { label: "Sobre Nós", href: "/metodologia" },
  ...
  resources: [
    ...
    { label: "FAQ", href: "/faq" },
    { label: "Área do Aluno", href: "/area-aluno" },
  ],
  legal: [
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-sm mb-6">
              Plataforma de cursos online premium focada em desenvolvimento
              profissional e especialização. Transformamos carreiras através
              de formação de excelência.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} FOKUS. Todos os direitos reservados.</p>
            <p>Feito em Portugal com dedicação.</p>
          </div>
        </div>
      </div>
    </footer>
